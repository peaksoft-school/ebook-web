...
import classes from './VendorImageSection.module.css'

const VendorImageSection = (props) => {
   const {
      mainPicture,
      secondPicture,
      thirdPicture,
   ...
   return (
      <section className={classes.uploadImageSectionVednor}>
         ...
         <div className={classes.imageUploadRulesVendor}>
